...
### Changed
- New project maintainer – [@Turbolqk](https://github.com/Turbolqk)
- Updated dnscrypt-proxy to v2.1.15
- Cleaned up and restructured the whole module
- Ships with my own configuration out of the box
